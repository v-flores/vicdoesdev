...
const FunctionalComponent = () => {
  return (
    <h1>
      {" "}
      Hello, I'm a functional component! I can take props as an arguement.
    </h1>
  )
}
```
...
class ClassComponent extends Component {
  render() {
    return (
      <div>
        {" "}
        Hello, I'm a Class Based Component. I must have a render method to
        return JSX.{" "}
      </div>
    )
  }
...
```javascript
<!--  This syntax WILL NOT work in React -->
```
...
```javascript
{
  /* This syntax WILL work in React */
}
```
